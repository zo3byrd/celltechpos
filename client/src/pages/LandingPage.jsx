        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{ borderTop: '1px solid #1e293b', paddingTop: 24, display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
              {/* Facebook */}
              <a href="https://www.facebook.com/profile.php?id=61589671754831" target="_blank" rel="noopener noreferrer" title="CellTechPOS on Facebook"
                style={{ color: '#475569', textDecoration: 'none', display: 'flex', alignItems: 'center' }}
                onMouseEnter={e => e.currentTarget.style.color='#1877f2'} onMouseLeave={e => e.currentTarget.style.color='#475569'}>
              ...
              {/* YouTube */}
              <a href="https://www.youtube.com/playlist?list=PLvRZywmevF72nGP5OWimMjHMaM9RxAKtG" target="_blank" rel="noopener noreferrer" title="CellTechPOS on YouTube"
                style={{ color: '#475569', textDecoration: 'none', display: 'flex', alignItems: 'center' }}
                onMouseEnter={e => e.currentTarget.style.color='#ff0000'} onMouseLeave={e => e.currentTarget.style.color='#475569'}>
                <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: 18, height: 18 }}><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
              </a>
